...
void CAL_MESSAGE_ESP(void)
{
  ...
  if (DataRe_ESP.header == 0xAA&& DataRe_ESP.footer == 0xDD) {  
    ...
    if (Cal_Parity_ESP == DataRe_ESP.parity) {
			...
			else if((B2_ESP&0x01)==0x01&&(DataRe_ESP.data[BOT2]&0x01)==0)
			{
				//开关A1关
				GPIO_CHANGE_FLAG=2;
			...
			else if((B2_ESP&0x02)==0x02&&(DataRe_ESP.data[BOT2]&0x02)==0)
			{
				//开关A2关
			...
			else if((B2_ESP&0x04)==0x04&&(DataRe_ESP.data[BOT2]&0x04)==0)
			{
				//开关B1关
				GPIO_CHANGE_FLAG=4;
			}
			...
			else if((B2_ESP&0x08)==0x08&&(DataRe_ESP.data[BOT2]&0x08)==0)
			{
				//开关B2关
			}
			...
			else if((B2_ESP&0x10)==0x10&&(DataRe_ESP.data[BOT2]&0x10)==0)
			{
				//开关C1关
			}
			...
			else if((B2_ESP&0x20)==0x20&&(DataRe_ESP.data[BOT2]&0x20)==0)
			{
				//开关C2关
			}
			...
			else if((B2_ESP&0x40)==0x40&&(DataRe_ESP.data[BOT2]&0x40)==0)
			{
				//开关D1关
			}
			...
			else if((B2_ESP&0x80)==0x80&&(DataRe_ESP.data[BOT2]&0x80)==0)
			{
				//开关D2关
			}
			//更新标志位
