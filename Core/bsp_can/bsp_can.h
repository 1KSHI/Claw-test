...
extern motor_measure_t *get_chassis_motor_measure_point_can1(uint8_t i);
extern motor_measure_t *get_chassis_motor_measure_point_can2(uint8_t i);

void motor_state_update_can1(void);
void motor_state_update_can2(void);
